...
exports.getLogin=(req,res,next)=>{
 ...
 exports.postLogout = (req, res, next) => {
  ...
  //       const firstConversation = (matchedAccount && Array.isArray(matchedAccount.conversations) && matchedAccount.conversations.length > 0) ? matchedAccount.conversations[0] : []; // or use {} depending on what Chat view expects
...
exports.postChat = (req, res, next) => {
  ...
  //       const list = Array.isArray(matchedAccount && matchedAccount.chattedAccount) ? matchedAccount.chattedAccount : [];
  //       // console.log(list);
  //       res.render('Chat', { chattedAccount: list , chatObject : matchedAccount.conversations[index] , selectedAccount : email}); // heare added selectedAccount
  //     })
  //     .catch(err => {
  //       console.error('getChat error:', err);
  //       res.render('Chat', { chattedAccount: [] , chatObject : [recipientEmail = "" , message = ""]});
